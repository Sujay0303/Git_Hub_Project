...
followerdf.coalesce(1).write.parquet("s3://oneandonlyonebucket13/followertable")

followingdf = df3.unionByName(df4)
followingdf.coalesce(1).write.parquet("s3://oneandonlyonebucket13/followingtable")
